...
$sql = "SELECT p.*, a.shopname FROM products p LEFT JOIN artisans a ON p.seller_id = a.user_id WHERE $where_sql $order_sql";
            ...
            <form class="header-search" method="GET" action="woodcraft_page.php">
                ...
                <div class="filter-dropdown" id="filterDropdown">
                    <div class="filter-section">
                        ...
                        <input type="text" name="pattern" placeholder="e.g. Teak, Mahogany..." class="filter-input" value="<?php echo htmlspecialchars($filter_pattern); ?>">
                    ...
                    <div class="filter-section">
                        <h4>Material</h4>
                        <input type="text" name="material" placeholder="e.g. Wood, Oak Wood" class="filter-input" value="<?php echo htmlspecialchars($filter_material); ?>">
                    </div>
                    <div class="filter-section">
                        <h4>Color Palette</h4>
                        <div class="color-options">
                            <button type="button" class="color-circle" style="background:#8d6e63;" title="Teak / Brown" onclick="setFilterColor('Teak / Brown')"></button>
                            <button type="button" class="color-circle" style="background:#5d4037;" title="Dark Teak" onclick="setFilterColor('Dark Teak')"></button>
                            <button type="button" class="color-circle" style="background:#3e2723;" title="Ebony" onclick="setFilterColor('Ebony')"></button>
                            <button type="button" class="color-circle" style="background:#d7ccc8;" title="Light Pine" onclick="setFilterColor('Light Pine')"></button>
                            <button type="button" class="color-circle" style="background:#a1887f;" title="Medium Oak" onclick="setFilterColor('Medium Oak')"></button>
                        </div>
