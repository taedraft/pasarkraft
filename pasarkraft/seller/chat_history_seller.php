                    ...
                    <div class="header-actions">
                        <form method="POST" style="display:flex; gap:5px;">
                            <?php if ($active_inquiry['status'] == 'In Discussion'): ?>
                                <button type="submit" name="update_status" value="Deal Agreed" class="btn-status agree">Accept
                                    Deal</button>
                                <button type="submit" name="update_status" value="No Deal" class="btn-status nodeal">No
                                    Deal</button>
                            <?php elseif ($active_inquiry['status'] == 'Deal Agreed'): ?>
                                <button type="submit" name="update_status" value="Sold" class="btn-status sold">Mark as
                                    Sold</button>
                                <button type="submit" name="update_status" value="In Discussion" class="btn-status">Cancel
                                    Deal</button>
                            <?php endif; ?>
                        </form>
                    </div>
